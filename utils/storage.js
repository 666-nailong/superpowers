...
function getQuestionData() {
  ...
  const extraQs = [
        ...
        { id: "q111", type: "fill", difficulty: 2, question: "已知某电路的戴维南等效Uoc=30V，Req=6Ω，当负载等于______时，可获得的最大功率为______", options: [], answer: "6Ω", explanation: "RL=Req时Pmax=Uoc²/(4Req)=900/(4×6)=37.5W。", image: "/assets/exam_pages/exam2019/4.jpg", chapter: "qch01", tags: [] },
        { id: "q112", type: "fill", difficulty: 2, question: "KCL定律是对电路中各支路______之间施加的线性约束关系，KVL定律是对电路中各支路______之间施加的线性约束关系______", options: [], answer: "电流", explanation: "KCL=电流约束（节点）；KVL=电压约束（回路）。", image: "/assets/exam_pages/exam2019/4.jpg", chapter: "qch01", tags: [] },
        ...
        { id: "q118", type: "fill", difficulty: 2, question: "电阻R1=100Ω，R2=200Ω，R3=300Ω。当R1与R2并联再与R3串联时，总电阻为______Ω______", options: [], answer: "366.7", explanation: "R12=R1∥R2=100×200/(100+200)=66.7Ω；R总=R12+R3=66.7+300=366.7Ω。", image: "/assets/exam_pages/exam2021/3.jpg", chapter: "qch01", tags: [] },
        { id: "q119", type: "fill", difficulty: 2, question: "电源电压12V，R1=4Ω，R2=6Ω并联，总电流为______A______", options: [], answer: "5", explanation: "Req=4×6/(4+6)=2.4Ω；I=12/2.4=5A。", image: "/assets/exam_pages/exam2021/3.jpg", chapter: "qch01", tags: [] },
        { id: "q120", type: "fill", difficulty: 2, question: "R=10Ω，C=0.1μF串联，电路的时间常数为______", options: [], answer: "1μs（1×10⁻⁶s）", explanation: "τ=RC=10×0.1×10⁻⁶=1×10⁻⁶s=1μs。", image: "/assets/exam_pages/exam2021/3.jpg", chapter: "qch08", tags: [] },
        { id: "q121", type: "fill", difficulty: 2, question: "V(t)=30+10sin(50t)伏特，R=5Ω，C=0.02F，交流电路的角频率为______弧度/秒______", options: [], answer: "50", explanation: "角频率ω=50 rad/s（sin函数中t的系数）。", image: "/assets/exam_pages/exam2021/3.jpg", chapter: "qch05", tags: [] },
        { id: "q122", type: "fill", difficulty: 2, question: "RLC电路中，L=0.2H，C=10μF，R=50Ω。当电流达到最大值一半时，电路中的能量为______焦耳______", options: [], answer: "0.025", explanation: "谐振时I最大，I一半时需具体分析。储能W=½LI²+½CU²。", image: "/assets/exam_pages/exam2021/4.jpg", chapter: "qch07", tags: [] },
        { id: "q123", type: "fill", difficulty: 2, question: "三角形电路R1=100Ω，R2=200Ω，R3=300Ω，R1与R2并联再与R3并联，总电阻为______Ω______", options: [], answer: "54.5", explanation: "三个并联：1/Req=1/100+1/200+1/300=0.01+0.005+0.0033=0.0183→Req=54.5Ω。", image: "/assets/exam_pages/exam2021/5.jpg", chapter: "qch01", tags: [] },
